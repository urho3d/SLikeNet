...
public class NetworkIDObject : IDisposable {
  ...
  protected void SetNetworkIDManagerOrig(NetworkIDManager manager) {
    if (this.GetType() == typeof(NetworkIDObject)) SLikeNetPINVOKE.NetworkIDObject_SetNetworkIDManagerOrig(swigCPtr, NetworkIDManager.getCPtr(manager)); else SLikeNetPINVOKE.NetworkIDObject_SetNetworkIDManagerOrigSwigExplicitNetworkIDObject(swigCPtr, NetworkIDManager.getCPtr(manager));
  }

  public virtual NetworkIDManager GetNetworkIDManager() {
    IntPtr cPtr = ((this.GetType() == typeof(NetworkIDObject)) ? SLikeNetPINVOKE.NetworkIDObject_GetNetworkIDManager(swigCPtr) : SLikeNetPINVOKE.NetworkIDObject_GetNetworkIDManagerSwigExplicitNetworkIDObject(swigCPtr));
    NetworkIDManager ret = (cPtr == IntPtr.Zero) ? null : new NetworkIDManager(cPtr, false);
    return ret;
  }

  public virtual ulong GetNetworkID() {
    ulong ret = ((this.GetType() == typeof(NetworkIDObject)) ? SLikeNetPINVOKE.NetworkIDObject_GetNetworkID(swigCPtr) : SLikeNetPINVOKE.NetworkIDObject_GetNetworkIDSwigExplicitNetworkIDObject(swigCPtr));
    return ret;
  }

  public virtual void SetNetworkID(ulong id) {
    if (this.GetType() == typeof(NetworkIDObject)) SLikeNetPINVOKE.NetworkIDObject_SetNetworkID(swigCPtr, id); else SLikeNetPINVOKE.NetworkIDObject_SetNetworkIDSwigExplicitNetworkIDObject(swigCPtr, id);
  }
