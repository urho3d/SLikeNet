...
public class FileListTransferCBInterface : IDisposable {
  ...
  public virtual bool Update() {
    bool ret = ((this.GetType() == typeof(FileListTransferCBInterface)) ? SLikeNetPINVOKE.FileListTransferCBInterface_Update(swigCPtr) : SLikeNetPINVOKE.FileListTransferCBInterface_UpdateSwigExplicitFileListTransferCBInterface(swigCPtr));
    return ret;
  }

  public virtual bool OnDownloadComplete(DownloadCompleteStruct dcs) {
    bool ret = ((this.GetType() == typeof(FileListTransferCBInterface)) ? SLikeNetPINVOKE.FileListTransferCBInterface_OnDownloadComplete(swigCPtr, DownloadCompleteStruct.getCPtr(dcs)) : SLikeNetPINVOKE.FileListTransferCBInterface_OnDownloadCompleteSwigExplicitFileListTransferCBInterface(swigCPtr, DownloadCompleteStruct.getCPtr(dcs)));
    return ret;
  }

  public virtual void OnDereference() {
    if (this.GetType() == typeof(FileListTransferCBInterface)) SLikeNetPINVOKE.FileListTransferCBInterface_OnDereference(swigCPtr); else SLikeNetPINVOKE.FileListTransferCBInterface_OnDereferenceSwigExplicitFileListTransferCBInterface(swigCPtr);
  }
