  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          SLikeNetPINVOKE.delete_uint24_t(swigCPtr);
        }
...
//------------
  ...
  public uint val {
    set {
      SLikeNetPINVOKE.uint24_t_val_set(swigCPtr, value);
    } 
    get {
      uint ret = SLikeNetPINVOKE.uint24_t_val_get(swigCPtr);
      return ret;
    } 
  }

  public uint24_t() : this(SLikeNetPINVOKE.new_uint24_t__SWIG_0(), true) {
  }
  ...
  private uint24_t OpPlusPlus() {
    uint24_t ret = new uint24_t(SLikeNetPINVOKE.uint24_t_OpPlusPlus(swigCPtr), true);
    return ret;
  }
  ...
  private bool OpNotEqual(uint24_t right) {
    bool ret = SLikeNetPINVOKE.uint24_t_OpNotEqual__SWIG_0(swigCPtr, uint24_t.getCPtr(right));
    if (SLikeNetPINVOKE.SWIGPendingException.Pending) throw SLikeNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private bool OpGreater(uint24_t right) {
    bool ret = SLikeNetPINVOKE.uint24_t_OpGreater__SWIG_0(swigCPtr, uint24_t.getCPtr(right));
    if (SLikeNetPINVOKE.SWIGPendingException.Pending) throw SLikeNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  private uint24_t OpPlus(uint24_t other) {
    uint24_t ret = new uint24_t(SLikeNetPINVOKE.uint24_t_OpPlus__SWIG_0(swigCPtr, uint24_t.getCPtr(other)), true);
    if (SLikeNetPINVOKE.SWIGPendingException.Pending) throw SLikeNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private uint24_t OpMinus(uint24_t other) {
    uint24_t ret = new uint24_t(SLikeNetPINVOKE.uint24_t_OpMinus__SWIG_0(swigCPtr, uint24_t.getCPtr(other)), true);
    if (SLikeNetPINVOKE.SWIGPendingException.Pending) throw SLikeNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private uint24_t OpDivide(uint24_t other) {
    uint24_t ret = new uint24_t(SLikeNetPINVOKE.uint24_t_OpDivide__SWIG_0(swigCPtr, uint24_t.getCPtr(other)), true);
    if (SLikeNetPINVOKE.SWIGPendingException.Pending) throw SLikeNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public uint24_t(uint a) : this(SLikeNetPINVOKE.new_uint24_t__SWIG_2(a), true) {
  }
  ...
  public bool Equals(uint right) {
    bool ret = SLikeNetPINVOKE.uint24_t_Equals__SWIG_1(swigCPtr, right);
    return ret;
  }

  private bool OpNotEqual(uint right) {
    bool ret = SLikeNetPINVOKE.uint24_t_OpNotEqual__SWIG_1(swigCPtr, right);
    return ret;
  }

  private bool OpGreater(uint right) {
    bool ret = SLikeNetPINVOKE.uint24_t_OpGreater__SWIG_1(swigCPtr, right);
    return ret;
  }

  private bool OpLess(uint right) {
    bool ret = SLikeNetPINVOKE.uint24_t_OpLess__SWIG_1(swigCPtr, right);
    return ret;
  }

  private uint24_t OpPlus(uint other) {
    uint24_t ret = new uint24_t(SLikeNetPINVOKE.uint24_t_OpPlus__SWIG_1(swigCPtr, other), true);
    return ret;
  }

  private uint24_t OpMinus(uint other) {
    uint24_t ret = new uint24_t(SLikeNetPINVOKE.uint24_t_OpMinus__SWIG_1(swigCPtr, other), true);
    return ret;
  }

  private uint24_t OpDivide(uint other) {
    uint24_t ret = new uint24_t(SLikeNetPINVOKE.uint24_t_OpDivide__SWIG_1(swigCPtr, other), true);
    return ret;
  }
