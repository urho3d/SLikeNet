...
public class UnsignedShortPointer : IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          SLikeNetPINVOKE.delete_UnsignedShortPointer(swigCPtr);
        }
  ...
  public UnsignedShortPointer() : this(SLikeNetPINVOKE.new_UnsignedShortPointer(), true) {
  }

  public void assign(ushort value) {
    SLikeNetPINVOKE.UnsignedShortPointer_assign(swigCPtr, value);
  }

  public ushort value() {
    ushort ret = SLikeNetPINVOKE.UnsignedShortPointer_value(swigCPtr);
    return ret;
  }
