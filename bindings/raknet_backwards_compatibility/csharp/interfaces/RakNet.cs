...
public class RakNet {
  ...
  public static readonly int SLNET_MAX_RETRIEVABLE_FILESIZE = RakNetPINVOKE.SLNET_MAX_RETRIEVABLE_FILESIZE_get();
  ...
  public static readonly string RAK_TIME_FORMAT_STRING = RakNetPINVOKE.RAK_TIME_FORMAT_STRING_get();
